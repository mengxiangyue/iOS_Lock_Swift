...
class MyViewController : UIViewController {
    ...
    override func loadView() {
        ...
        lockButton.setTitle("NSLock", for: UIControlState())
        ...
        conditionLockButton.setTitle("NSConditionLock", for: UIControlState())
        ...
        recursiveLockButton.setTitle("NSRecursiveLock", for: UIControlState())
        ...
        conditionButton.setTitle("NSCondition", for: UIControlState())
        ...
        synchronizedButton.setTitle("@synchronized", for: UIControlState())
        ...
        dispatchSemaphoreButton.setTitle("dispatch_semaphore", for: UIControlState())
        ...
        OSSpinLockButton.setTitle("OSSpinLock", for: UIControlState())
        ...
        pthread_mutexButton.setTitle("pthread_mutex", for: UIControlState())
